...
SELECT P.SEQFAMILIA SEQFAMILIA,
  ...
  FROM MRL_PRODUTOEMPRESA X INNER JOIN MAP_PRODUTO P      ON P.SEQPRODUTO = X.SEQPRODUTO
                            ...
                            INNER JOIN MAP_FAMEMBALAGEM E ON E.SEQFAMILIA = P.SEQFAMILIA
                             LEFT JOIN MAP_PRODCODIGO C   ON C.SEQPRODUTO = X.SEQPRODUTO AND C.QTDEMBALAGEM = E.QTDEMBALAGEM AND C.TIPCODIGO = 'E' AND C.INDUTILVENDA = 'S'
 ...
 WHERE 1=1 -- Filtros definidor pela Neides
   ...
   GROUP BY P.SEQFAMILIA, G.NROCGCCPF, DIGCGCCPF, SEQFORNECEDOR, NOMERAZAO,
            DESCCOMPLETA, DESCGENERICA, E.QTDEMBALAGEM, E.EMBALAGEM, CODNBMSH, CATEGORIAN1, CATEGORIAN2, CATEGORIAN3, CATEGORIAN4, CATEGORIAN5, STATUSCOMPRA, X.SEQPRODUTO;
